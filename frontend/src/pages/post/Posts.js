					...
					<Fade>
						...
						{data.posts && data.posts.length === 0 ? (
							...
							<>
								...
								<PaginationComponent pages={data.pages} page={page} />
							</>
						)}
						...
						<Modal isOpen={show} toggle={toggle}>
							{action === "ADD" && <AddPost toggle={toggle} />}
							{action === "DELETE" && (
								<DeletePost post={modalData} toggle={toggle} />
							)}
							{action === "UPDATE" && (
								<EditPost post={modalData} toggle={toggle} />
							)}
						</Modal>
					</Fade>
				</Route>
