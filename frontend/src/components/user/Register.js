...
import { Form, FormGroup, FormFeedback, Button, Label, Input, Col, Alert, Fade } from 'reactstrap';
  ...
  return (
    <Fade>
      ...
      <Form className="my-3" onSubmit={handleSubmit}>
        ...
        <FormGroup row className="justify-content-center">  
          <Col sm={6}>
            <Button block color="primary" disabled={isSubmitting} type="submit">Registrovať</Button>
          </Col>
        </FormGroup>
      </Form>
    </Fade>
