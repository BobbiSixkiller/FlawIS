...
function GrantBudget(props) {
	const INITIAL_STATE = {
		...
		material: props.form.budget[props.i]
			? props.form.budget[props.i].material
			: "",
		services: props.form.budget[props.i]
			? props.form.budget[props.i].services
			: "",
		indirect: props.form.budget[props.i]
			? props.form.budget[props.i].indirect
			: "",
		salaries: props.form.budget[props.i]
			? props.form.budget[props.i].salaries
			: "",
		members: props.form.budget[props.i]
			? props.form.budget[props.i].members
			: [],
	};
	...
	const {
		...
		errors,
		valid,
	} = useFormValidation(INITIAL_STATE, validateBudget, addBudget);
					...
					<Col sm={3}>
						<FormGroup>
							...
							<Input
								id="salaries"
								name="salaries"
								placeholder="Položka pre mzdové náklady"
								onBlur={handleBlur}
								onChange={handleChange}
