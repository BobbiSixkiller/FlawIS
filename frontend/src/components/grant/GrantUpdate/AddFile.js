...
function AddFile(props) {
	...
	const { handleChange, handleSubmit, values, errors, valid } =
		useFormValidation(INITIAL_STATE, validateDocument, addDocument);
	...
	async function addDocument(formData) {
		...
		try {
			...
			const res = await api.post(`grant/${modal.data._id}/file`, formData, {
				headers: {
