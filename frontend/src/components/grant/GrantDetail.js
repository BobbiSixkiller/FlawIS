...
function GrantDetail() {
	...
	const users = getUsers("user/names", "GET", accessToken);
	console.log(users);
			...
			<Fade>
				<Container>
									...
									<FormGroup>
										<Col>
											...
											<Input
												...
												plaintext
												readOnly
												value={new Date(grant.createdAt).toLocaleString()}
											/>
										</Col>
									</FormGroup>
									<FormGroup>
										<Col>
											...
											<Input
												...
												plaintext
												readOnly
												value={new Date(grant.updatedAt).toLocaleString()}
											/>
										</Col>
									</FormGroup>
								</Row>
					...
					<Modal isOpen={modal.show} toggle={() => setModal(!modal)}>
						{modal.action === "editBudget" && (
							<EditBudget getData={getData} modal={modal} setModal={setModal} />
						)}
						{modal.action === "editMember" && (
							<EditMember getData={getData} modal={modal} setModal={setModal} />
						)}
						{modal.action === "deleteMember" && (
							<DeleteMember
								getData={getData}
								modal={modal}
								setModal={setModal}
						...
						{modal.action === "deleteAnnouncement" && (
							<DeleteAnnouncement
								getData={getData}
								modal={modal}
								setModal={setModal}
