...
interface ConferenceData {
  ...
  slug: string;
  translations: {
    sk: { name: string; logoUrl: string };
    en: { name: string; logoUrl: string };
  };
  dates: { start: Date; end: Date };
}

function ListItem({ data, lng }: { data?: ConferenceData; lng: string }) {
...
export default function ListConferences({
  ...
  initialData: Connection<ConferenceData>;
  lng: string;
}) {
